...
//					new Employee("Jane Doe", "CTO", "jane.doe@example.com")));
			logger.info("Préchargement de la base de données avec "+gpsRepository.save(
					gps1));
			logger.info("Préchargement de la base de données avec "+gpsRepository.save(
					gps2));
			logger.info("Préchargement de la base de données avec "+adresseRepository.save(
					adresse1));
			logger.info("Préchargement de la base de données avec "+adresseRepository.save(
					adresse2));
			logger.info("Préchargement de la base de données avec "+litRepository.save(
					litJumeaux1));
			logger.info("Préchargement de la base de données avec "+litRepository.save(
					litJumeaux2));
			logger.info("Préchargement de la base de données avec "+litRepository.save(
			...
			logger.info("Préchargement de la base de données avec "+litRepository.save(
					litSuperpose2));
			logger.info("Préchargement de la base de données avec "+chambreRepository.save(
					campanile1));
			logger.info("Préchargement de la base de données avec "+chambreRepository.save(
					campanile2));
			logger.info("Préchargement de la base de données avec "+chambreRepository.save(
			...
			logger.info("Préchargement de la base de données avec "+chambreRepository.save(
					regina4));
			logger.info("Préchargement de la base de données avec "+hotelRepository.save(
					hotel1));
			logger.info("Préchargement de la base de données avec "+hotelRepository.save(
					hotel2));
			logger.info("Préchargement de la base de données avec "+hotelPartenaireTarifRepository.save(
					partenaire1));
			logger.info("Préchargement de la base de données avec "+hotelPartenaireTarifRepository.save(
					partenaire2));
			logger.info("Préchargement de la base de données avec "+hotelPartenaireTarifRepository.save(
					partenaire3));
			logger.info("Préchargement de la base de données avec "+agenceRepository.save(
					agenceA));
			logger.info("Préchargement de la base de données avec "+agenceRepository.save(
					agenceB));
		};
